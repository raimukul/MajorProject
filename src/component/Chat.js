...
//console.log(value)
  return (
  <div style={{display:'flex',flexDirection:'column',flexGrow:'4'}} className='mt-5'>
        ...
        <h2 className='App'> Post Section </h2>
        <form className='App'>
        ...
        {
          posts.map((post , id)=>{
              return( <h2 key={id} onClick={()=>selectPost(post)}>{post.name} </h2>)
          })
        } 
    </div>)  
}
